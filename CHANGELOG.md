...
- **logging**: add logging functionality to graph components([`505ff5a`](https://github.com/lyestarzalt/Dinar_watch/commit/505ff5ab68df361f8ba2dc8cf8c31c204084dfd8)) (by Lyes Tarzalt)
- **graph**: add trend colors for line graph visualization([`749b828`](https://github.com/lyestarzalt/Dinar_watch/commit/749b8283436ef14fd3b893143c15a6771dfdae7b)) (by Lyes Tarzalt)
- add animation to custom line graph rendering([`1563480`](https://github.com/lyestarzalt/Dinar_watch/commit/15634801ede18df28d69f714a156bfe4278f3b9a)) (by Lyes Tarzalt)
- CustomLineGraph additional configuration options and improved rendering([`dda276b`](https://github.com/lyestarzalt/Dinar_watch/commit/dda276b8eb4934cbe7fa8501ce2f4d7a41b9219d)) (by Lyes Tarzalt)
- custome line graph([`b1fba08`](https://github.com/lyestarzalt/Dinar_watch/commit/b1fba088ed4d73d213d59be7c6610caf68cffd42)) (by Lyes Tarzalt)

### Bugs fixed:

- conversion calculation not updating when switching currency direction([`3bd277a`](https://github.com/lyestarzalt/Dinar_watch/commit/3bd277a02501dd7c5276b47557e85cede7798d2f)) (by Lyes)
- improve error handling for fetching exchange rates and historical data([`3992081`](https://github.com/lyestarzalt/Dinar_watch/commit/3992081989890660c0730b2334b4e82dd161e566)) (by Lyes)
- **i18n**: update translations for about section and error messages across multiple languages([`8f7d3c6`](https://github.com/lyestarzalt/Dinar_watch/commit/8f7d3c694d255d3b301b2e72d18f385014d1de35)) (by Lyes)
- **i18n**: update multilingual content for clarity and consistency([`79ec7a5`](https://github.com/lyestarzalt/Dinar_watch/commit/79ec7a5f3d5d72da34a6387d81d15d411083fdcc)) (by Lyes)
- update text formatting to display one decimal place in line graph painter([`42bd9ef`](https://github.com/lyestarzalt/Dinar_watch/commit/42bd9effa15f235241e20e0d48abb47816e05c90)) (by Lyes Tarzalt)
- handle edge cases and prevent NaN values in line graph rendering([`f0420ed`](https://github.com/lyestarzalt/Dinar_watch/commit/f0420ed072836669769651f40ac949fc2f24fae2)) (by Lyes Tarzalt)

## 1.4.7 (2024-12-15)

### New feature:

- enhance currency input widget with improved layout and input formatting([`9c174bb`](https://github.com/lyestarzalt/Dinar_watch/commit/9c174bb43f4cfc8d0a283edac70ddce447e88c3d)) (by Lyes Tarzalt)
- enhance input formatter to handle empty input and limit decimal places([`020ecc3`](https://github.com/lyestarzalt/Dinar_watch/commit/020ecc3e7426825a38b2f470aa4691bca4779097)) (by Lyes Tarzalt)
- Improve button selection UI([`5ca60cc`](https://github.com/lyestarzalt/Dinar_watch/commit/5ca60cc6274f7d0be1879245612ff08b0fb8f5e8)) (by Lyes Tarzalt)

### Bugs fixed:

- increase font size for currency list item text([`65bf7a1`](https://github.com/lyestarzalt/Dinar_watch/commit/65bf7a1a2067dbe1c6369f07527fbd09de85dc31)) (by Lyes Tarzalt)

## 1.4.6 (2024-11-02)

### New feature:

- Display both buy and sell values on currency tile([`666204e`](https://github.com/lyestarzalt/Dinar_watch/commit/666204e58ac1a36038fac12e82a2a4a9748014c3)) (by Lyes Tarzalt)

### Bugs fixed:

- double add banner showing on graph page([`14b4446`](https://github.com/lyestarzalt/Dinar_watch/commit/14b44463323146bfb81da073cf9539c8ed94bbe2)) (by Lyes Tarzalt)
- swap currencies button is too big([`2d04ffc`](https://github.com/lyestarzalt/Dinar_watch/commit/2d04ffc94509aa39834e0a535ee2f5fef259c3e9)) (by Lyes Tarzalt)
- graph select currency button obscured ad view([`1335e9f`](https://github.com/lyestarzalt/Dinar_watch/commit/1335e9fa43ae8d59654602969afad4737cb2ae84)) (by Lyes Tarzalt)
